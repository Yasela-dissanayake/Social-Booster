...
// Set trust proxy for rate limiting to work properly
...
// Skip helmet for download routes and in development
app.use((req, res, next) => {
  if (req.path.startsWith('/admin/download/') || process.env.NODE_ENV === 'development') {
    return next();
  }
